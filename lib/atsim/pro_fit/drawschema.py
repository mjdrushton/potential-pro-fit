# Tool for generating figure of webmonitor database schema for inclusion in documentation
...
def _mk_label(
    ...
    html = (
        '<<TABLE CELLSPACING="0" CELLPADDING="1" BORDER="0" CELLBORDER="%d" BALIGN="LEFT"><TR><TD><FONT POINT-SIZE="10">%s</FONT></TD></TR>'
...
def main():
    ...
    pdgraph.write_png(outputfilename)
