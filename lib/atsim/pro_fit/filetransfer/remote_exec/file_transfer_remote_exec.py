...
def mkdir(channel, channel_id, remote_root, msg):
    ...
    dirmade_msg = dict(
        msg="MKDIR", channel_id=channel_id, id=fileid, remote_path=remote_path
    )
...
def mkdirs(channel, channel_id, remote_root, msg):
    ...
    dirmade_msg = dict(
        msg="MKDIRS", channel_id=channel_id, id=fileid, remote_path=remote_path
    )
...
def start_channel(channel):
    ...
    channeltypes = {
        "START_UPLOAD_CHANNEL": upload_remote_exec,
