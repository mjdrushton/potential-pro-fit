...
batch_size : 2
    ...
    """ % {
        ...
        expect = [
            ...
            ([1650.0], [dict(A=10.0, B=17, C=30.000000, D=19)]),
        ]
...
class SpreadsheetRowIteratorTestCase(unittest.TestCase):
    ...
    def testAllFit(self):
        ...
        with open(spreadfilename) as infile:
            ...
            from atsim.pro_fit.minimizers._spreadsheet import (
                _SpreadsheetRowIterator,
            )
    ...
    def testStartAndEndRow(self):
        ...
        with open(spreadfilename) as infile:
            rowit = _SpreadsheetRowIterator(
                variables, infile, startRow=0, endRow=0
            )
            actual = [dict(v.variablePairs) for v in rowit]
            expect = [
                dict(A=1.0, B=2.0, C=3, D=4.0),
        ...
        with open(spreadfilename) as infile:
            rowit = _SpreadsheetRowIterator(
                variables, infile, startRow=3, endRow=3
            )
            actual = [dict(v.variablePairs) for v in rowit]
            expect = [
                # dict(A = 1.0 , B= 2.0 , C = 3  , D = 4.0),
        ...
        with open(spreadfilename) as infile:
            rowit = _SpreadsheetRowIterator(
                variables, infile, startRow=1, endRow=2
            )
            actual = [dict(v.variablePairs) for v in rowit]
            expect = [
                # dict(A = 1.0 , B= 2.0 , C = 3  , D = 4.0),
    ...
    def testRowIncrement(self):
        ...
        with open(spreadfilename) as infile:
            ...
            rowit = _SpreadsheetRowIterator(
                variables, infile, startRow=1, endRow=3, rowIncrement=1
            )
            actual = [dict(v.variablePairs) for v in rowit]
        ...
        with open(spreadfilename) as infile:
            ...
            rowit = _SpreadsheetRowIterator(
                variables, infile, startRow=1, endRow=3, rowIncrement=2
            )
            actual = [dict(v.variablePairs) for v in rowit]

        expect = [dict(A=6.0, B=7, C=8, D=9), dict(A=16, B=17, C=18, D=19)]
        ...
        expect = [dict(A=1.0, B=2.0, C=3, D=4.0), dict(A=16, B=17, C=18, D=19)]
