...
class IterationSeries_VariablesColumns_TestCase(DBTestCase):
    ...
    def testVariablesColumns(self):
        ...
        tableIterator = db.IterationSeriesTable(
            self.engine,
            primary_column,
            iteration_filter,
            candidate_filter,
        ...
        actual = {"columns": columns, "values": list(tableIterator)}
    ...
    def testVariablesColumnProvider(self):
        ...
        with itseries._temporaryCandidateContextManager(
            ...
            with self.assertRaises(KeyError):
                col = _VariablesColumnProvider(
                    conn, meta, "variable:morse_Mg_O_C_bad"
                )
