...
class IterationSeriesMetaEvaluatorColumnTestCase(DBTestCase):
    ...
    def testMetaEvaluatorColumns(self):
        ...
        t = db.IterationSeriesTable(
            self.engine,
            columns=[
                "evaluator:meta_evaluator:Gd_Ea:deltaD18_16:extracted_value"
            ],
        )
...
class IterationSeries_Evaluators_TestCase(DBTestCase):
    ...
    def testEvaluatorColumnLabelSplit(self):
        ...
        actual = _EvaluatorColumnProvider._splitColumnLabel(
            "evaluator:CaO:CaO:Gulp:elastic_c12:merit_value"
        )
        expect = dict(
            jobName="CaO",
    ...
    def testValueTypeExtract(self):
        ...
        expect = {
            "columns": [
                ...
                "candidate_number",
                "merit_value",
                "evaluator:CaO:CaO:Gulp:elastic_c12:extracted_value",
            ],
            "values": [
    ...
    def testMultipleEvaluatorColumns(self):
        ...
        t = db.IterationSeriesTable(
            ...
            columns=[
                "evaluator:CaO:CaO:Gulp:elastic_c12:merit_value",
                "evaluator:MgO:MgO:Gulp:cell_a:extracted_value",
            ],
        )
        expect = {
            "columns": [
    ...
    def testValueTypePercentDiff(self):
        ...
        expect = {
            "columns": [
                ...
                "candidate_number",
                "merit_value",
                "evaluator:CaO:CaO:Gulp:cell_a:percent_difference",
            ],
            "values": [
