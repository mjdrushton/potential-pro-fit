...
class UtilTestCase(unittest.TestCase):
    ...
    def testPercentDiffBadValues(self):
        ...
        self.assertEqual(
            -10, pdiff({"extracted_value": 90, "expected_value": 100})
        )

        # Zero as expected value
        self.assertEqual(
            None, pdiff({"extracted_value": 90, "expected_value": 0.0})
        )

        self.assertEqual(
            None, pdiff({"extracted_value": 90, "expected_value": None})
        )
        self.assertEqual(
            None, pdiff({"extracted_value": None, "expected_value": 90})
        )
        self.assertEqual(
            None, pdiff({"extracted_value": None, "expected_value": None})
        )
