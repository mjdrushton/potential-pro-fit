...
def _checkRSerializedDB(filename):
    ...
    assert_that(
        sorted(["x", "y", "z", "x_name", "y_name", "z_name"])
    ).is_equal_to(sorted(rstruct.names))
