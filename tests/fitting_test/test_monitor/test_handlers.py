...
class TestHandlers(CherryPyDBTestCaseBase):
  ...
  def testEvaluators(self):
    ...
    expect = [( 'CaO:Gulp' , 'elastic_c12'          , 57.81  , 1.5955   , 1.0    , 56.2145  , None               , 'CaO', -97.2400968690538  ),
              ( 'CaO:Gulp' , 'elastic_c11'          , 221.89 , 113.3894 , 1.0    , 108.5006 , None               , 'CaO', -48.8983730677363 ),
              ( 'CaO:Gulp' , 'elastic_c44'          , 80.32  , 1.5955   , 1.0    , 78.7245  , None               , 'CaO', -98.0135707171315 ),
              ( 'CaO:Gulp' , 'cell_c'               , 4.811  , 9.73857  , 10.0   , 49.2757  , None               , 'CaO', 102.422988983579 ),
              ( 'CaO:Gulp' , 'cell_b'               , 4.811  , 9.73857  , 10.0   , 49.2757  , None               , 'CaO', 102.422988983579 ),
              ( 'CaO:Gulp' , 'cell_a'               , 4.811  , 9.73857  , 10.0   , 49.2757  , None               , 'CaO', 102.422988983579 ),
              ( 'CaO:Gulp' , 'optimisation_penalty' , 0.0    , 0.0      , 1000.0 , 0.0      , None               , 'CaO', None ),
              ( 'MgO:Gulp' , 'elastic_c12'          , 95.2   , 329.5643 , 1.0    , 234.3643 , None               , 'MgO', 246.180987394958 ),
              ( 'MgO:Gulp' , 'elastic_c11'          , 297.0  , 445.8063 , 1.0    , 148.8063 , None               , 'MgO', 50.1031313131313 ),
              ( 'MgO:Gulp' , 'elastic_c44'          , 155.7  , 329.5643 , 1.0    , 173.8643 , None               , 'MgO', 111.666217084136 ),
              ( 'MgO:Gulp' , 'cell_c'               , 4.212  , 5.061349 , 10.0   , 8.49349  , None               , 'MgO', 20.1649810066477 ),
              ( 'MgO:Gulp' , 'cell_b'               , 4.212  , 5.061349 , 10.0   , 8.49349  , 'Error Message'    , 'MgO', 20.1649810066477 ),
