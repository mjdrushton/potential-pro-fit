...
class TemplateJobFactoryTestCase(unittest.TestCase):
  ...
  def testCreateJob(self):
    ...
    factory = pro_fit.jobfactories.TemplateJobFactory(srcpath, os.path.join(self.rootDir,'runner_files', 'runner_name'), 'Runner',
        'Job',
        [])
...
"""
  ...
  def testCreateJob_no_runner_files(self):
    ...
    factory = pro_fit.jobfactories.TemplateJobFactory(srcpath, None, 'Runner',
        'Job',
        [])
...
""")
    ...
    self.assertEqual(
        os.path.abspath(os.path.join(self.rootDir, 'runner_files', 'runner_name')),
        jf.runnerFilesPath)
