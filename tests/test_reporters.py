                ...
                [
                    ...
                    [
                        ER(
                            ...
                            100.0,
                            100.0,
                            evaluatorName="Penalty Evaluator",
                        ),
                        ER(
                            "Bulk",
                            90.0,
        ...
        with engine.connect() as conn:
            ...
            expect = [
                ...
                },
                {
                    ...
                    "upper_bound": None,
                    "calculated_flag": True,
                    "calculation_expression": "A+rho+C",
                },
            ]
    ...
    def testStatus(self):
        ...
        with engine.connect() as conn:
            ...
            for row in results:
                actual.append(dict(list(zip(list(row.keys()), row))))
            expect = [
                {"id": 1, "runstatus": "Finished", "title": "fitting_run"}
            ]
            testutil.compareCollection(self, expect, actual)
            results.close()
