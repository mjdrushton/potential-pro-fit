...
class GulpParseOutputConfigurationTestCase(unittest.TestCase):
  ...
  def testParseComponentsOfEnergy(self):
    ...
    expect = { 'componentsOfEnergyAtStart' : { 'interatomicPotentials'                : 26.88207570,
              ...
              'componentsOfEnergyAtEnd'   :  { 'interatomicPotentials'                : 26.88207570,
                                               'monopoleMonopoleReal'                 : -57.34563079,
                                               'monopoleMonopoleRecip'                : -133.83771541,
                                               'monopoleMonopoleTotal'                : -191.18334619,
                                               'totalLatticeEnergy'                   : -164.30127050,
    ...
    testfile = open(os.path.join(_getResourceDirectory(), 'opti_conp_prop_comp_eam_outputsection.res'),'r')
    expect = { 'componentsOfEnergyAtStart' : { 'interatomicPotentials'                : 87.44928342,
              ...
              'componentsOfEnergyAtEnd'   :  { 'interatomicPotentials'                : 35.84080889,
  ...
  def testParseMechanicalProperties(self):
    ...
    expect = { 'bulkModulus'     : {'reuss' : 232.60093, 'voigt' : 232.60093, 'hill' : 232.60093},
               ...
               'velocitySWave'   : {'reuss' : 19.27988, 'voigt' : 19.73566, 'hill' : 19.50910},
               'velocityPWave'   : {'reuss' : 33.83448, 'voigt' : 34.18307, 'hill' : 34.00923},
               'compressibility' : 0.00429921,
               'youngsModuli'    : [272.88851,  272.88851,  272.88851],
               'poissonsRatio'   : [ [None, 0.30447     ,0.30447],
