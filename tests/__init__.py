...
class FitConfigTestCase(unittest.TestCase):
  ...
  def testMetaEvaluators(self):
    ...
    self.assertEqual(pro_fit.metaevaluators.FormulaMetaEvaluator, type(metaevaluators[0]))
  ...
  def testCalculatedVariables(self):
    ...
    self.assertAlmostEqual(405.66942 + .75271639, dict(transvars.variablePairs)['cvar'])
